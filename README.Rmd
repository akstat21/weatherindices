...
To calculate weather indices you require weekly weather data and year yield data. Both the data should be separate variables. The number of data points in weather variable should be multiple of numbers of years of yield data and number of weeks considered in each year.
